...
const DICT: Dict = {
  ...
  'onboard.welcome.title': { ru: 'Шашки, которые учат выигрывать', en: 'Checkers that teach you to win' },
  'onboard.welcome.body': { ru: 'Сыграй партию в красивой 3D-доске, получай подсказки по тактике и после финала смотри разбор ошибок как у личного тренера.', en: 'Play on a cinematic 3D board, get tactical guidance during the match, then review mistakes with a personal AI coach.' },
  'onboard.welcome.feat1.t': { ru: 'AI-тренер в партии', en: 'AI Coach in-game' },
  'onboard.welcome.feat1.b': { ru: 'Подсказывает угрозы, форсированные взятия и планы до хода.', en: 'Highlights threats, forced captures and plans before you move.' },
  'onboard.welcome.feat2.t': { ru: 'Разбор после финала', en: 'Post-game review' },
  'onboard.welcome.feat2.b': { ru: 'Оценка 0–100, ошибки и лучшие альтернативы по ходам.', en: '0–100 score, mistakes and stronger alternatives by move.' },
  'onboard.welcome.feat3.t': { ru: 'Матчи с характером', en: 'Matches with personality' },
  'onboard.welcome.feat3.b': { ru: 'Играй против AI-соперников разной силы или в хотсит за одним экраном.', en: 'Face AI opponents with different styles or play local hotseat.' },
