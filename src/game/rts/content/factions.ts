...
export const FACTIONS: Record<FactionId, FactionMeta> = {
  ...
  titan: {
    ...
    description: 'Armored industrial arm. Slower but far tougher. Barracks also train AT Grenadiers. Build mode: quickset — worker stakes the site then returns to work; construction proceeds on its own.',
    workerKind: 'harvesterTitan',
    infantryKind: 'paladin',
    tankKind: 'siegeWalker',
    specialKind: 'railgun',
    availableBuildings: ['hq', 'power', 'refinery', 'barracks', 'factory', 'tech', 'turret'],
    extraBarracksUnit: 'atGrenadier',
