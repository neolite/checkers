...
export const VFX_PRESETS: readonly VfxPreset[] = [
  ...
  },
  {
    ...
    layers: [
      ...
      { type: 'mesh', shape: 'cap', color: 0x7a3420, radius: 8.6, opacity: 0.72, grow: 1.26, lifeMs: 4300, delayMs: 360, rise: 7.0, blending: 'normal', material: 'smoke', y: 8.2 },
      { type: 'mesh', shape: 'dome', color: 0x5a2418, radius: 3.7, opacity: 0.58, grow: 1.08, lifeMs: 4000, delayMs: 420, rise: 8.2, blending: 'normal', material: 'smoke', y: 5.5 },
      { type: 'mesh', shape: 'dome', color: 0x62301f, radius: 3.7, opacity: 0.48, grow: 1.22, lifeMs: 3800, delayMs: 520, offsetX: -2.9, offsetZ: 1.5, rise: 6.4, blending: 'normal', material: 'smoke', y: 8.9 },
      { type: 'mesh', shape: 'dome', color: 0x6b3928, radius: 3.5, opacity: 0.46, grow: 1.25, lifeMs: 3700, delayMs: 560, offsetX: 3.0, offsetZ: -1.2, rise: 6.0, blending: 'normal', material: 'smoke', y: 9.2 },
      { type: 'mesh', shape: 'dome', color: 0x3b1b16, radius: 3.0, opacity: 0.42, grow: 1.24, lifeMs: 3600, delayMs: 620, offsetX: 0.4, offsetZ: -3.1, rise: 5.6, blending: 'normal', material: 'smoke', y: 9.6 },
