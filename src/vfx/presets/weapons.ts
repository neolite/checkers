...
export const VFX_PRESETS: readonly VfxPreset[] = [
  ...
  },
  {
    ...
    budgetClass: 'expensive',
    layers: [
      { type: 'light', color: 0xffd49a, intensity: 10.5, distance: 46, lifeMs: 480, y: 7.2 },
      { type: 'mesh', shape: 'disc', color: 0xffc26a, radius: 7.6, opacity: 0.48, grow: 1.42, lifeMs: 780, y: 0.06 },
      { type: 'mesh', shape: 'ring', color: 0xffffff, radius: 3.2, opacity: 0.82, grow: 2.35, lifeMs: 380, y: 0.2 },
      { type: 'mesh', shape: 'ring', color: 0xff8a3a, radius: 7.8, opacity: 0.42, grow: 1.72, lifeMs: 980, y: 0.22 },
      { type: 'mesh', shape: 'column', color: 0xffc170, radius: 2.0, height: 23, opacity: 0.34, grow: 1.12, lifeMs: 920, y: 0.2 },
      { type: 'mesh', shape: 'dome', color: 0xfff0ba, radius: 6.2, opacity: 0.36, grow: 1.18, lifeMs: 640, y: 1.15 },
      { type: 'mesh', shape: 'cap', color: 0xff8a42, radius: 7.8, opacity: 0.30, grow: 1.28, lifeMs: 1600, y: 9.2 },
      { type: 'sprite', texture: 'spark', color: 0xffffff, size: 9.0, lifeMs: 115, opacity: 1.0, grow: 0.5, randomRotation: true, y: 5.0 },
      { type: 'sprite', texture: 'flame', color: 0xff8f36, size: 9.8, lifeMs: 520, opacity: 0.9, grow: 1.18, randomRotation: true, y: 3.2 },
      { type: 'sprite', texture: 'smoke', color: 0x5d5750, size: 8.9, lifeMs: 2600, opacity: 0.68, grow: 2.05, randomRotation: true, y: 5.2 },
      { type: 'sprite', texture: 'smoke', color: 0x34302c, size: 7.4, lifeMs: 3100, opacity: 0.44, grow: 2.55, randomRotation: true, y: 8.5 },
      { type: 'shockwave', color: 0xffe0a2, radius: 10.2, lifeMs: 720, y: 0.16 },
      { type: 'shockwave', color: 0xff6e35, radius: 6.4, lifeMs: 420, y: 0.2 },
