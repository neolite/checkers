...
export const VFX_PRESETS: readonly VfxPreset[] = [
  ...
  },
  {
    ...
    budgetClass: 'normal',
    layers: [
      { type: 'mesh', shape: 'sphere', color: 0xffb15e, radius: 4.8, opacity: 0.16, grow: 1.35, lifeMs: 850, y: 0.85 },
  ...
  },
  {
    ...
    budgetClass: 'expensive',
    layers: [
      { type: 'light', color: 0xffd49a, intensity: 8.5, distance: 42, lifeMs: 520, y: 7.2 },
      { type: 'mesh', shape: 'sphere', color: 0xfff4c0, radius: 7.2, opacity: 0.42, grow: 1.05, lifeMs: 680, y: 2.2 },
      { type: 'mesh', shape: 'sphere', color: 0xff7a32, radius: 9.4, opacity: 0.22, grow: 1.28, lifeMs: 1150, y: 1.1 },
      { type: 'mesh', shape: 'column', color: 0xffd08a, radius: 2.8, height: 20, opacity: 0.28, grow: 1.2, lifeMs: 850, y: 0.2 },
      { type: 'sprite', texture: 'spark', color: 0xffffff, size: 8.4, lifeMs: 130, opacity: 1.0, grow: 0.52, randomRotation: true, y: 5.0 },
      { type: 'sprite', texture: 'flame', color: 0xffa24a, size: 9.6, lifeMs: 560, opacity: 0.95, grow: 1.35, randomRotation: true, y: 3.2 },
      { type: 'sprite', texture: 'smoke', color: 0x6e6860, size: 8.4, lifeMs: 2500, opacity: 0.66, grow: 1.95, randomRotation: true, y: 5.2 },
      { type: 'sprite', texture: 'smoke', color: 0x3f3c38, size: 6.2, lifeMs: 2900, opacity: 0.38, grow: 2.4, randomRotation: true, y: 7.5 },
